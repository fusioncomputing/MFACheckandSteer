...
3. Walk SecOps through the Entra onboarding playbook (`docs/guides/entra-tenant-onboarding.md`) and collect feedback on RBAC/consent steps.
4. Enrich the PowerShell module with Entra MFA ingestion logic (Phase 3) once service principal credentials are available.
5. Build detection rules and response playbooks aligned with roadmap items 4.x and 5.x.
6. Expand CI gates (linting, packaging) after the module gains functional commands, and maintain documentation parity as tooling evolves.
